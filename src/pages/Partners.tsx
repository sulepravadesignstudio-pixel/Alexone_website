        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center py-16">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5, duration: 1 }}
              className="lg:col-span-6 relative hidden lg:flex flex-wrap gap-3 items-center justify-center py-12">
              {MATERIALS.partners.map((p, i) => (
                <motion.div
                  ...
                  className="relative bg-white px-5 py-3 font-serif tracking-[0.18em] cursor-default"
                  style={{
                    fontSize: `${0.85 + (i % 3) * 0.18}rem`,
                    color: i % 4 === 0 ? '#C9A84C' : 'rgba(44,37,32,0.5)',
      ...
      <div className="relative overflow-hidden border-y py-5" style={{ borderColor: 'rgba(201,168,76,0.2)' }}>
        ...
        <motion.div animate={{ x: ['0%', '-50%'] }} transition={{ duration: 28, repeat: Infinity, ease: 'linear' }}
          ...
          {[...MATERIALS.partners, ...MATERIALS.partners].map((p, i) => (
            <span key={i} className="font-serif text-lg uppercase tracking-[0.28em] whitespace-nowrap" style={{ color: 'rgba(201,168,76,0.35)' }}>{p}</span>
          ))}
        </motion.div>
      </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* initials avatar */}
                    <div
                      className="w-14 h-14 rounded-2xl flex items-center justify-center font-serif text-xl transition-all duration-400 group-hover:scale-110 group-hover:rotate-3"
                      style={{
