...
const socials = [
  { name: 'Instagram', href: 'https://www.instagram.com/alexone_interior', icon: Instagram },
  { name: 'Facebook', href: 'https://www.facebook.com/alexoneinterior', icon: Facebook },
  ...
  return (
    <footer className="relative overflow-hidden border-t border-[#E2C97E]/12 bg-[linear-gradient(180deg,#17130F_0%,#0D0A08_100%)] px-6 pt-20 pb-10 text-white">
      ...
      <div className="container relative z-10 mx-auto">
        ...
        <div className={`flex flex-col gap-4 border-t border-white/8 pt-8 text-[10px] uppercase tracking-[0.24em] text-white/38 md:flex-row md:items-center md:justify-between ${RAIL_TEXT_INSET}`}>
